...
from mp3monitoring import Core
...
def load_config_data():
    ...
    """
    save_dict = {}
    with Core.SAVE_FILE.open('r', encoding='utf-8') as reader:
...
def save_config_data(mod_time_dict):
    ...
    """
    with Core.SAVE_FILE.open('w', encoding='utf-8') as writer:
        writer.write(Core.VERSION + '\n')
