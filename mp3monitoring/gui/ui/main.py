...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dataTableView.setAutoFillBackground(False)
        self.dataTableView.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.dataTableView.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.dataTableView.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        self.dataTableView.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.dataTableView.setTabKeyNavigation(False)
        self.dataTableView.setAlternatingRowColors(False)
        ...
        self.dataTableView.verticalHeader().setDefaultSectionSize(0)
