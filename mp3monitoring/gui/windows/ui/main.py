...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dataTableView.setFocusPolicy(QtCore.Qt.ClickFocus)
        ...
        self.dataTableView.setEditTriggers(QtWidgets.QAbstractItemView.AnyKeyPressed|QtWidgets.QAbstractItemView.DoubleClicked|QtWidgets.QAbstractItemView.EditKeyPressed)
        self.dataTableView.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.dataTableView.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectItems)
        ...
        self.dataTableView.horizontalHeader().setCascadingSectionResizes(False)
        self.dataTableView.horizontalHeader().setHighlightSections(False)
        self.dataTableView.verticalHeader().setVisible(False)
        self.gridLayout.addWidget(self.dataTableView, 0, 0, 1, 1)
